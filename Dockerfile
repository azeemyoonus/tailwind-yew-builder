...
RUN npm install --global tailwindcss@1.9.6 tailwindcss-cli@latest postcss@8.4.14 autoprefixer@10.4.19 clean-css-cli@5.5.0 npm-run@latest pg-promise@4.8.1 pdfkit@0.11.0 sanitize-html@1.4.2 socket.io@3.1.2
